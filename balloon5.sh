...
NUMBALLOONS=9
SLEEP=5
declare -a matrixwidth=( 2048 2048 2048 4096 4096 4096 8192 8192 8192   )
declare -a startingmemory=( 10 20 30 10 20 40 10 20 40 )
TOTALMEMORY_MB=100
...
do
	...
	do
	  ...
	  STARTINGMEMORY_MB=${startingmemory[$index]}
		...
		echo "Running cache adaptive to generate memory profiles"
		./cgroups.sh $1
		...
		do
			cgexec -g memory:$1 ./build/balloon2 > "balloon_log.txt" 0 $TOTALMEMORY_MB $STARTINGMEMORY_MB $NUMBALLOONS $j $MATRIXWIDTH &
