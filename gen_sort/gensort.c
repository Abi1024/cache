...
void gen_ascii_rec(unsigned char *rec_buf, rand_queue *rq)
{
     ...
     */
    temp = rand.hi8;
    rec_buf[0] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[1] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[2] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[3] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[4] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[5] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[6] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[7] = (unsigned char)('!' + (temp % 94));
    temp = rand.lo8;
    rec_buf[8] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
    rec_buf[9] = (unsigned char)('!' + (temp % 94));
    temp /= 94;
